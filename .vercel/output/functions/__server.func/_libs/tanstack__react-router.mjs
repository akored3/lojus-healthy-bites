import { j as jsxRuntimeExports, r as reactExports, R as React__default } from "./react.mjs";
import { w as warning } from "./tiny-warning.mjs";
import { r as replaceEqualDeep, t as trimPathRight, g as getLocationChangeInfo, h as handleHashScroll, i as isNotFound, d as defaultGetScrollRestorationKey, a as restoreScroll, s as storageKey, b as rootRouteId, c as createControlledPromise, e as isRedirect, f as transformReadableStreamWithRouter, j as transformPipeableStreamWithRouter, p as preloadWarning, k as functionalUpdate, l as exactPathTest, m as removeTrailingSlash, n as deepEqual, B as BaseRootRoute, o as BaseRoute, q as isModuleNotFoundError, R as RouterCore } from "./tanstack__router-core.mjs";
...
function Asset({
  ...
  switch (tag) {
    ...
    case "link":
      return /* @__PURE__ */ jsxRuntimeExports.jsx("link", { ...attrs, suppressHydrationWarning: true });
    case "style":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "style",
        {
...
function HeadContent() {
  const tags = useTags();
  return tags.map((tag) => /* @__PURE__ */ reactExports.createElement(Asset, { ...tag, key: `tsr-meta-${JSON.stringify(tag)}` }));
}
